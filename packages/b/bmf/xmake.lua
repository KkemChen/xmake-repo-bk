package("bmf")
    ...
    add_urls("https://github.com/KkemChen/bmf/archive/refs/tags/xmake_$(version).tar.gz")
    add_urls("https://github.com/KkemChen/bmf.git", {submodules = false})
    -- add_versions("latest", "a399ed6be0931fc40aec94f9f3849ba560262a67")
